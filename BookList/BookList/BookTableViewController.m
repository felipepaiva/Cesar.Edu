...
- (void)viewDidLoad
{
    ...
    book1.title = @"Core Java 2012";
    book1.author = @"NSGlauber";
    book1.publisher = @"Cesar.EDu";
    
    _books = [[NSMutableArray alloc] initWithObjects:book1, nil];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    BookCellViewController *cell = [tableView dequeueReusableCellWithIdentifier:CellIdentifier];
